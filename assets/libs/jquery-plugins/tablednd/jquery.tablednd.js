...
jQuery.tableDnD = {
    ...
    build: function(options) {
        ...
        this.each(function() {
            ...
            this.tableDnDConfig = jQuery.extend({
                ...
                dragIconHandle: null // If you give the name of a class here, then only Icons with this class will be draggable
            }, options || {});
    ...
    makeDraggable: function(table) {
        ...
        } else if (config.dragIconHandle) {
        	jQuery('.'+config.dragIconHandle, table).each(function() {
                // The cell is bound to "this"
                jQuery(this).bind(startEvent, function(ev) {
                    jQuery.tableDnD.initialiseDrag(jQuery(this).closest('tr')[0], table, this, ev, config);
                    return false;
                });
            })
        } else {
