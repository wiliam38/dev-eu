		...
		<table style="width: 100%; margin-top: 40px;" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
					...
					<td class="border-bottom title right"  style="width: 60%;">Pavadzīmes Nr. 19B{$order.number}</td>
				</tr>
				...
				<tr><td>Maksājuma veids</td><td class="border-bottom">{$order.pay_type_name}<br/><b>Pavadzīme ir apmaksāta</b></td></tr>
